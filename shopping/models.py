...
class Movie(models.Model):
    ...
    name = models.CharField(verbose_name="商品名称", max_length=255, unique=True)
    director = models.CharField(verbose_name="店铺名称", max_length=255)
    country = models.CharField(verbose_name="国家/地点", max_length=255)
    years = models.DateField(verbose_name='上架时间')
    leader = models.CharField(verbose_name="价格", max_length=1024)
    ...
    origin_image_link = models.URLField(verbose_name='图片地址', max_length=255, null=True)
...
class Rate(models.Model):
    movie = models.ForeignKey(
        Movie, on_delete=models.CASCADE, blank=True, null=True, verbose_name="商品id"
    )
    user = models.ForeignKey(
...
class Comment(models.Model):
    ...
    movie = models.ForeignKey(Movie, on_delete=models.CASCADE, verbose_name="商品")
