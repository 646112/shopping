...
# sys.path.extend(['D:\\github\\shopping-recommendation-system\\python-django\\movieSystem', ])
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "shoppingrecomend.settings")
...
def get_url_movie():
    ...
    while urls:
        ...
        for movie_href in movie_hrefs:
            print('fetch shopping href', movie_href)
